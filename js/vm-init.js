...
window.addEventListener("load", function () {
    ...
    if (!linuxSerial || !linuxCont) {
        console.error("Linux VM containers are missing from index.html");
    ...
    try {
        ...
        window.emulator = createVM({
            ...
            bzimage_url: "./images/bzImage",
            initrd_url: "./images/rootfs.cpio.gz",
        });
        ...
        if (typeof updateStatus === "function") updateStatus("Linux VM failed to start. Check console and file paths.");
    }
});
